...
class QuizModel {
  ...
  factory QuizModel.fromJson(Map<String, dynamic> json) => QuizModel(
    ...
    links: QuizModelLinks.fromJson(json["links"]),
    likes: json["likes"],
...
class QuizModelLinks {
  ...
  factory QuizModelLinks.fromJson(Map<String, dynamic> json) => QuizModelLinks(
    self: json["self"],
    html: json["html"],
